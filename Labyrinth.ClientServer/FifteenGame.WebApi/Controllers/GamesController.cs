...
namespace FifteenGame.WebApi.Controllers
{
    public class GamesController : ApiController
    {
        ...
        public GameReply CheckMatch([FromBody] MakeMoveRequest request)
        {
            var fisrsbuutonRowCol =  request.FisrsbuutonRowCol; 
            
            var reply = _gameService.CheckMatch(request.GameId, fisrsbuutonRowCol);
            return ToDto(reply);
        }
