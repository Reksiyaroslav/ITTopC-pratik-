...
namespace FifteenGame.ClientProxy.Services
{
    public class GameServiceProxy : IGameService
    {
        ...
        {
            var httpContent = JsonContent.Create(new MakeMoveRequest { GameId = gameId, FisrsbuutonRowCol = FisrsbuutonRowCol});
        ...
        private GameModel FromDto(GameReply game)
        {
            var model = new GameModel
            {
                ...
                ExitRowCol = new int[] {game.ExitRow,game.ExitCol},
                PlaerRowCol = new int[] {game.PlaerRow,game.PlaerCol},
